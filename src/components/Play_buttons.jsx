  ...
  return (
    <>
        <div className='flex flex-row justify-evenly space-x-6 w-[550px] self-center items-center'>
            ...
            <div onClick={() => onPageChange && onPageChange("MapViewer_page")} className=' bg-[#ff4655] hover:bg-[#ff5865] transition-colors text-white items-center justify-center font-bold text-2xl flex h-[50px] w-48 cursor-pointer'>
                START
            </div>
