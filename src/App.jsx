...
import AgentSelect_page from "./Pages/AgentSelect_page";
    ...
    <>
      <ScaleWrapper>
        ...
        <>
          ...
          {currentPage === "AgentSelect_page" && <AgentSelect_page onPageChange={handlePageChange} />}
